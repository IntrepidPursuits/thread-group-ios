...
- (void)setContentMode:(TGNetworkPopupContentMode)contentMode {
    if (contentMode == TGNetworkPopupContentModeSearching) {
        ...
        TGSpinnerView *spinnerView = [[TGSpinnerView alloc] initWithFrame:CGRectZero clockwiseImage:[UIImage tg_popupWhiteSpinnerClockwise] counterClockwiseImage:[UIImage tg_popupWhiteSpinnerCounterClockwise]];
        [self constrainImageViewToContainer:spinnerView];
