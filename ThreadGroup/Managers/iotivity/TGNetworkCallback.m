...
- (void)onPetitionResult:(const CallbackResult_COMM_PET *)result {
    NSLog(@"%s not implemented in base class", __PRETTY_FUNCTION__);
...
@implementation CallbackResult_COMM_PET

@end

@implementation CallbackResult_JOIN_FIN

@end

@implementation CallbackResult_JOIN_URL
